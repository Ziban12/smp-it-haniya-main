    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="{{ route('employee.grades.create') }}" class="list-group-item list-group-item-action">
                            <i class="fas fa-star"></i> Record Grades
                        </a>
                        <a href="{{ route('employee.attendance.create') }}" class="list-group-item list-group-item-action">
