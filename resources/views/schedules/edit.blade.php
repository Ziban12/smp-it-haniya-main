        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('employee.schedules.update', $schedule->schedule_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('subject_id') is-invalid @enderror" id="subject_id" name="subject_id" required>
                                @foreach ($subjects as $subject)
                                    <option value="{{ $subject->subject_id }}" {{ old('subject_id', $schedule->subject_id) == $subject->subject_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('academic_year_id') is-invalid @enderror" id="academic_year_id" name="academic_year_id" required>
                                @foreach ($academicYears as $year)
                                    <option value="{{ $year->academic_year_id }}" {{ old('academic_year_id', $schedule->academic_year_id) == $year->academic_year_id ? 'selected' : '' }}>
