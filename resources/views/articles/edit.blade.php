            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('employee.articles.update', $article->article_id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="article_type" class="form-label">Article Type <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('article_type') is-invalid @enderror" 
                                   id="article_type" name="article_type" placeholder="e.g., News, Tutorial, Blog"
                                   value="{{ old('article_type', $article->article_type) }}" required>
                            @error('article_type')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
